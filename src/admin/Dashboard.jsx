  ...
  return (
    ...
    <div className="bg-primary w-full h-full flex flex-wrap justify-around items-center px-10 overflow-auto">
        ...
        <form className="">
          ...
          <button className="bg-[rgba(0,0,0,0.51)] flex items-center  text-white w-40 mx-auto  px-2 py-3 rounded-tl-2xl rounded-br-2xl hover:rounded-2xl my-5 transition-all"><Upload className='px-2 size-8'/> Upload</button>
        </form>
    </div>
    </>
  )
